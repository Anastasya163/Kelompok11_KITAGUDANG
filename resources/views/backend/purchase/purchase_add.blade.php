...
<script type="text/javascript">
    $(document).ready(function(){
        // Generate unique purchase number on page load
        generateUniquePurchaseNo();

        // Function to generate unique purchase number
        function generateUniquePurchaseNo() {
            // You can customize this to generate a unique purchase number as needed
            var uniquePurchaseNo = "PUR-" + Date.now();
            
            // Set the generated purchase number to the input field
            $('#purchase_no').val(uniquePurchaseNo);
        }
    });
</script>
